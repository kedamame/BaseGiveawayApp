...
export function WalletConnect() {
  ...
  // Debug logging
  useEffect(() => {
    console.log('[WalletConnect] State:', { isConnected, isReconnecting, waitingForReconnect, address });
    console.log('[WalletConnect] isInMiniApp:', isInMiniApp);
  }, [isInMiniApp, isConnected, isReconnecting, waitingForReconnect, address]);
  ...
  // Show placeholder during hydration or waiting for reconnection
  if (!mounted || waitingForReconnect) {
    return (
